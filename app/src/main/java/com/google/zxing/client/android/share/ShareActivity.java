...
public final class ShareActivity extends Activity {
	...
	private final View.OnClickListener clipboardListener = new View.OnClickListener() {
		@Override
		public void onClick(View v) {
			// Should always be true, because we grey out the clipboard button in onResume()
			// if it's empty
	...
	/**
	 * Takes a contact Uri and does the necessary database lookups to retrieve that
	 * person's info, then sends an Encode intent to render it as a QR Code.
	 *
	 * @param contactUri
	...
	private void showContactAsBarcode(Uri contactUri) {
		...
		Cursor cursor;
		try {
			// We're seeing about six reports a week of this exception although I don't
			// understand why.
		...
		// Don't require a name to be present, this contact might be just a phone
		// number.
	...
	private static String massageContactData(String data) {
		// For now -- make sure we don't put newlines in shared contact data. It messes
		// up
